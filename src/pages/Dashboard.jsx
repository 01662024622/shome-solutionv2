      ...
      <Row gutter={[24, 24]}>
        ...
        >
          <div className="whiteBox shadow" style={{ height: '380px' }}>
            ...
            >
              <h3 style={{ color: '#22075e', marginBottom: 30 }}>Khách hàng</h3>

              <Progress type="dashboard" percent={25} width={148} />
              <p>Khách hàng mới của Tháng 4</p>
              <Divider />
              <Statistic
      ...
      <Row gutter={[24, 24]}>
        ...
        >
          <div className="whiteBox shadow">
            <div className="pad20">
              <h3 style={{ color: '#22075e', marginBottom: 5 }}>Hóa đơn</h3>
            </div>
        ...
        >
          <div className="whiteBox shadow">
            <div className="pad20">
              <h3 style={{ color: '#22075e', marginBottom: 5 }}>Báo giá</h3>
            </div>
